...
class DataArguments:
    ...
    repeat_times: int = field(default=1, metadata={"help": "fixed bug"})
...
class CustomTrainingArguments(TrainingArguments):
    ...
    weighted_loss_mode: str = field(default=None, metadata={"help": "coba"})
    coba_warmup_steps: int = field(default=100, metadata={"help": "coba warmup steps"})
    coba_history_length: int = field(default=200, metadata={"help": "coba history length"})
    coba_tau: float = field(default=5, metadata={"help": "coba tau"})
    coba_update_interval: int = field(default=1, metadata={"help": "coba update interval"})
    coba_sample_valid_num: int = field(default=1, metadata={"help": "coba sample valid num"})
    coba_batch_rate: float = field(default=0, metadata={"help": "Exact Batch Size Rate"})
